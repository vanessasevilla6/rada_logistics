...
<div class="flex-1">
    ...
    <div class=" w-full h-full md:h-screen  py-12 px-12  bg-white bg-no-repeat bg-cover" id="app">
        ...
        <div class=" flex w-full  bg-green-700 text-white justify-between content-center p-4 rounded mb-5">
            <h2 class="font-bold font-sans text-2xl align-middle p-4">FACULTADES</h2>
        ...
        <div class="w-full  bg-gray-100 p-2 mx-auto rounded">
            ...
            <table id="facultades-table" class="display responsive  bg-white stripe " cellspacing="0" width="100%">
                <thead class="bg-green-700 text-white ">
                    <tr class="rounded my-5">
                        <th>Nombre </th>
                        <th>Campus al que pertenece</th>

                    </tr>
                </thead>
                <tbody class="text-xs text-center">
                    <tr v-for="facultad in facultades" :key="facultad.idFacultad">
                ...
                methods: {
                    ...
                    obtenerFacultades() {
                        ...
                        axios.get(this.url + "getAllFacultades").then(response => {
                            ...
                            this.dataTable.destroy();
                            this.$nextTick(function() {
                                this.dataTable = $('#facultades-table').DataTable({
                                    "language": {
                                        "url": "//cdn.datatables.net/plug-ins/1.11.3/i18n/es-mx.json"
                                    },
                                    "pagingType": "numbers",
