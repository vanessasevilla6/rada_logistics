...
<div class="flex-1">
    ...
    <div class=" w-full h-full md:h-screen  py-12 px-12  bg-white bg-no-repeat bg-cover" id="app">
        ...
        <div class=" flex w-full  bg-green-700 text-white justify-between content-center p-4 rounded mb-5">
            <h2 class="font-bold font-sans text-2xl align-middle p-4">CICLOS </h2>
        ...
        <div class="grid grid-cols-1">
            <div class="w-full  bg-gray-100 p-2 mx-auto rounded">
                ...
                <div class="flex justify-center items-center m-1 font-medium py-1 px-2 bg-white rounded-md text-yellow-400 bg-green-700 border border-green-700 " v-if="onSuccessTbl">
                    <div slot="avatar">
                ...
                <table id="ciclos-table" class="display responsive  bg-white stripe " cellspacing="0" width="100%">
                    ...
                    <tbody class="text-xs text-center">
                        <tr v-for="ciclo in ciclos" :key="ciclo.idCiclo">
                            <td>{{ciclo.idCiclo}}</td>
                            <td>{{ciclo.ciclo}}</td>
                            <td>
                                <div class="grid grid-cols-1  md:grid-cols-2 gap-2 content-center ">
                                    <a href="#" class="bg-green-900 hover:bg-green-500 text-white font-bold p-2  rounded items-center text-xs">
                                        <i class="fa-solid fa-trophy fill-current"></i>
                                        <p class="break-words hidden md:block">Torneos</p>
                                    </a>

                                    <a href="#" v-on:click="eliminar(ciclo.idCiclo)" class="bg-green-900 hover:bg-green-500 text-white font-bold p-2  rounded items-center text-xs">
                                        <i class="fa-solid fa-circle-minus fill-current"></i>
                                        <p class="break-words  hidden md:block">Eliminar</p>
                                    </a>
                                </div>
           ...
           -->
            ...
            <div id="modal_ciclo" v-if="modal" class=" absolute inset-0 bg-white bg-opacity-30 h-screen w-full flex justify-center items-start md:items-center pt-10 md:pt-0">
                    ...
                    <div class="w-full ">
                        <div class="flex items-center align-center content-center mx-10">
                            ...
                            <div class="w-full relative flex-1 text-left  items-center justify-items-center opacity-100 z-50 pt-5 pb-5">
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        ...
                                        <input name="name" v-model="cicloNuevo.nombre" type="text" placeholder="Ingresa el titulo del ciclo" required class="appearance-none block w-full bg-gray-200 text-gray-700 border border-grey-300 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" />
                                    </div>
                                </div>
                            ...
                            <div class="absolute bottom-0 left-0 px-4 py-3 border-t border-gray-200 w-full flex justify-end items-center gap-3">
                                <button @click="guardar()" class="bg-green-700 hover:bg-green-900 px-4 py-2 rounded text-white focus:outline-none">Agregar</button>
            ...
            var app = new Vue({
                ...
                methods: {
                    ...
                    guardar() {
                        ...
                        axios.post(this.url + "/agregaCiclo", {
                            ciclo: this.cicloNuevo
                        }).then(response => {
                    ...
                    eliminar(idCiclo) {
                        axios.get(this.url + "/eliminaCiclo/" + idCiclo).then(response => {
                    ...
                    obtenerCiclos() {
                        ...
                        axios.get(this.url + "/getCiclos").then(response => {
                            ...
                            this.$nextTick(function() {
                                this.dataTable = $('#ciclos-table').DataTable({
                                    "language": {
                    ...
                    showAlert: function(message, code) {
                        ...
                        if (code == 1) {
                            this.onSuccess = true;
                            this.obtenerCiclos();
                            setTimeout(() => this.cerrarModalNuevoTrainer(), 1000);
                        } else {
                            this.onError = true;
                        }
                        //               this.mensa
                    ...
                    showAlertTbl: function(message, code) {
                        ...
                        if (code == 1) {
                            ...
                            this.obtenerCiclos();
                            setTimeout(() => this.cerrarMsg(), 1000);
                        } else {
                            this.onErrorTbl = true;
                            setTimeout(() => this.cerrarMsg(), 2000);
                        }
                        //               this.mensa
                    },
